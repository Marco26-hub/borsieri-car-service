...
2. Impostare su Netlify le variabili:
   - `SUPABASE_URL`
...
5. Collegare il dominio `borsiericarservice.it` e `www.borsiericarservice.it` su Netlify.
6. Aggiornare DNS del dominio come indicato da Netlify.
